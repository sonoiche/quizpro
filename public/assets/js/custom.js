(function () {
  ...
  // var mainHeaderProfile = document.getElementById("user-dropdown");
  // new SimpleBar(mainHeaderProfile, { autoHide: true });
  /* header dropdowns scroll */
})();
...
// $('#mainHeaderProfile').click(function (e) { 
//   e.preventDefault();
//   $('#profile-nav-menu').toggle();
// });

// $('#mainHeaderProfile').blur(function() {
//   $('#profile-nav-menu').hide();
// });