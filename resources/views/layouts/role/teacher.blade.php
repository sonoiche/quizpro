            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">My Classrooms</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1 pages-ul">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">My Classrooms</a>
                        </li>
                        <li class="slide">
                            <a href="{{ url('teacher/classrooms') }}" class="side-menu__item">List of Rooms</a>
                        </li>
                        <li class="slide">
                            <a href="{{ url('teacher/classrooms/create') }}" class="side-menu__item">Create Room</a>
                        </li>
                    </ul>
                </li>
                <li class="slide has-sub">
                ...
                <li class="slide">
                    <a href="{{ url('teacher/students') }}" class="side-menu__item">
